      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            {/* WhatsApp CTA — opens the subscribe form (captures a lead first) */}
            <SubscribeButton
              source="footer_cta"
              className="mt-6 w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-5 rounded-xl text-sm transition-all duration-300 shadow-lg hover:shadow-green-500/40"
            >
