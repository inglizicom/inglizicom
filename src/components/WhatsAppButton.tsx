...
// Opens the subscribe form (captures a lead in the CRM) before handing off to WhatsApp.
import SubscribeButton from '@/components/SubscribeButton'

export default function WhatsAppButton() {
  return (
    <div className="whatsapp-wrapper" style={{ position: 'fixed', bottom: 0, right: 0, zIndex: 999 }}>
