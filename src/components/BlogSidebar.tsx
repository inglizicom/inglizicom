      ...
      <div className="bg-gradient-to-br from-brand-700 to-brand-900 rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-3">
            ...
            <SubscribeButton
              source="blog_sidebar"
              className="flex items-center justify-center gap-2 bg-[#25d366] hover:bg-[#20b858] text-white font-bold py-3 rounded-xl transition-all duration-300 text-sm w-full"
            >
