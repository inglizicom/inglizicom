...
export const LESSONS: Lesson[] = [
  ...
  /* ─────────────────────────── 2 · VOWELS ─────────────────────────── */
  {
    ...
    examples: [
      { en: 'c*a*t', ar: 'قطة', why: 'One short vowel in the middle — the simplest possible English syllable.', whyAr: 'حرف علّة قصير في الوسط: أبسط مقطع إنجليزي.' }, { en: 'd*o*g', ar: 'كلب', why: 'Same shape with *o*. Three letters, one vowel, one syllable.', whyAr: 'الشكل نفسه مع o: ثلاثة أحرف ومقطع واحد.' }, { en: 's*u*n', ar: 'شمس', why: '*u* here is short. Every syllable needs a vowel, and this one has exactly one.', whyAr: 'u قصيرة هنا، وكل مقطع يحتاج علّة، وهذا فيه واحدة.' },
      { en: 'p*e*n', ar: 'قلم', why: '*e* short. Notice the pattern: consonant, vowel, consonant.', whyAr: 'e قصيرة، ولاحظ النمط: ساكن فعلّة فساكن.' }, { en: 'b*oo*k', ar: 'كتاب', why: 'TWO vowels working as one sound — *oo* is a vowel team, not two syllables.', whyAr: 'حرفا علّة بصوت واحد؛ oo فريق لا مقطعان.' }, { en: 'tr*ee*', ar: 'شجرة', why: '*ee* is another team, and it makes a long sound.', whyAr: 'ee فريق آخر يعطي صوتًا طويلًا.' },
      { en: 'r*ai*n', ar: 'مطر', why: '*ai* is a team too. English has far more vowel SOUNDS than vowel letters.', whyAr: 'ai فريق أيضًا؛ أصوات العلّة أكثر من حروفها بكثير.' }, { en: 'h*ou*s*e*', ar: 'بيت', why: '*ou* is a team, and the final *e* is silent — it changes the sound before it.', whyAr: 'ou فريق، و e الأخيرة صامتة تغيّر الصوت قبلها.' }, { en: '*a*ppl*e*', ar: 'تفاحة', why: 'Starts AND ends with a vowel. The final *e* is silent but not useless.', whyAr: 'تبدأ وتنتهي بعلّة، و e الأخيرة صامتة لكنها ليست بلا فائدة.' },
      { en: '*o*r*a*ng*e*', ar: 'برتقالة', why: 'Three vowels in one short word — this is why they cannot be skipped.', whyAr: 'ثلاثة أحرف علّة في كلمة قصيرة، ولهذا لا تُسقط.' }, { en: 'w*a*t*e*r', ar: 'ماء', why: '*a* then *e*: two syllables, and each one owns a vowel.', whyAr: 'a ثم e: مقطعان ولكلٍّ علّته.' }, { en: 't*a*bl*e*', ar: 'طاولة', why: 'The silent *e* at the end lengthens the *a* before it — a core spelling rule.', whyAr: 'e الصامتة تُطيل a قبلها، وهي قاعدة إملائية أساسية.' },
      { en: 'ch*ai*r', ar: 'كرسي', why: '*ai* again — recognising vowel teams is what makes spelling predictable.', whyAr: 'ai مرّة أخرى؛ معرفة الفرق تجعل الإملاء متوقّعًا.' }, { en: 'sch*oo*l', ar: 'مدرسة', why: '*oo* again, in a word you will write constantly.', whyAr: 'oo مرّة أخرى في كلمة ستكتبها كثيرًا.' }, { en: 't*ea*ch*e*r', ar: 'معلّم', why: '*ea* is a team; the *er* ending is a whole syllable of its own.', whyAr: 'ea فريق، ونهاية er مقطع مستقلّ.' },
      { en: 'st*u*d*e*nt', ar: 'طالب', why: 'Two syllables, two vowels — count the vowels and you have counted the syllables.', whyAr: 'مقطعان وعلّتان؛ عُدّ العلل تَعُدّ المقاطع.' }, { en: 'f*a*m*i*ly', ar: 'عائلة', why: '*y* is acting as a VOWEL here — the sixth vowel, part-time.', whyAr: 'y تعمل حرف علّة هنا؛ إنها السادسة بدوام جزئي.' }, { en: 'fr*ie*nd', ar: 'صديق', why: '*ie* is a team, and this word is a famous spelling trap.', whyAr: 'ie فريق، وهذه الكلمة فخّ إملائي مشهور.' },
      { en: 'c*i*t*y*', ar: 'مدينة', why: '*y* as a vowel again, this time at the end of the word.', whyAr: 'y علّة مرّة أخرى، وهنا في آخر الكلمة.' }, { en: 'h*a*ppy', ar: 'سعيد', why: '*a* short, then *y* as a vowel — two syllables, two vowel sounds.', whyAr: 'a قصيرة ثم y علّة: مقطعان وصوتان.' }, { en: 'm*o*rn*i*ng', ar: 'صباح', why: 'Two syllables again. Say it slowly and you will hear where they split.', whyAr: 'مقطعان أيضًا؛ انطقها ببطء لتسمع موضع الفصل.' },
      { en: '*e*v*e*n*i*ng', ar: 'مساء', why: 'Three syllables, three vowel sounds. The rule scales up perfectly.', whyAr: 'ثلاثة مقاطع وثلاثة أصوات؛ القاعدة تتّسع تمامًا.' }, { en: '*u*mbr*e*ll*a*', ar: 'مظلّة', why: 'Four vowels in one word — English words are built ON vowels, not around them.', whyAr: 'أربعة أحرف علّة في كلمة؛ الكلمة الإنجليزية مبنيّة على العلل لا حولها.' }, { en: '*a*n*i*m*a*l', ar: 'حيوان', why: 'Every syllable here has its own *a* — three vowels, three beats.', whyAr: 'كل مقطع هنا له a خاصّته: ثلاث علل وثلاث نبضات.' },
    ],
    exercises: [
