...
export const LESSONS: Lesson[] = [
  ...
  /* ─────────────────────────── 2 · VOWELS ─────────────────────────── */
  {
    ...
    explain: {
      ...
      points: [
        ...
        { en: 'Vowels also decide doubling: si*t* → si*tt*ing (short vowel doubles the consonant)', ar: 'حروف العلّة تحدّد مضاعفة الحرف الساكن أيضًا' },
      ],
    },
    examples: [
  ...
  /* ─────────────────────────── 22.5 · EXPANDING YOUR PARAGRAPH (B1 · studio) ─────────────────────────── */
  {
    ...
    examples: [
      { en: 'Bare: My job is tiring. → +*R*: My job is tiring, *because I stand for nine hours every day*.', ar: 'مجرّد ← + سبب' },
      { en: 'Bare: My city is beautiful. → +*E*: My city is beautiful; *for example, the old medina glows orange at sunset*.', ar: 'مجرّد ← + مثال' },
      { en: 'Bare: I love winter mornings. → +*D*: I love winter mornings — *the cold air, the empty streets, the first coffee*.', ar: 'مجرّد ← + تفصيل' },
      { en: 'Bare: English opened doors for me. → +*R*: …*since every good job here asks for it*.', ar: 'الفعل + السبب' },
      { en: 'Bare: My mother is patient. → +*E*: …*For instance, she taught me to read without once raising her voice*.', ar: 'الصفة + المثال المُثبِت' },
      { en: 'Bare: The course changed my writing. → +*D*: *In fact, my first email used to take an hour; now it takes six minutes*.', ar: 'التفصيل بالأرقام أقوى دليل' },
      { en: 'Double it: support + *because* … + *For example*, … = three sentences from one.', ar: 'دعم + سبب + مثال = ثلاث جمل من واحدة' },
      { en: '✗ Off-topic is not expansion: “My job is tiring. *My sister lives in Spain*.” — cut it.', ar: 'الخروج عن الموضوع ليس توسيعًا — احذفه' },
    ],
    exercises: [
  ...
  /* ─────────────────────────── 26 · FRIENDLY EMAILS & MESSAGES ─────────────────────────── */
  {
    ...
    examples: [
      { en: 'Subject that gets opened: *Come visit us this summer!* (not “Hello”)', ar: 'موضوع يُفتح — لا «Hello» فارغة' },
      { en: '*Hi Yousef,* — the name is the warmest word in the email.', ar: 'الاسم أدفأ كلمة في الرسالة' },
      { en: '*I hope you’re doing well.* — one line of warmth before business.', ar: 'جملة دفء قبل الموضوع' },
      { en: '*I’m writing to invite you* to spend a week with us in Agadir.', ar: 'سبب الكتابة بوضوح' },
      { en: '*Thanks so much for* the book — I finished it in two nights.', ar: 'الشكر مع تفصيل يثبت أنك تقصده' },
      { en: '*Let me know* which dates work for you, and I’ll arrange everything.', ar: 'الخطوة التالية واضحة' },
      { en: 'Warm closings: *Take care,* · *See you soon,* · *Best,* + your first name.', ar: 'خواتيم ودّية' },
      { en: 'Stiff ✗: “I am writing to inform you that I would like to meet.” → Warm ✓: *Are you free on Saturday?*', ar: 'المتصلّب ✗ ← الودّي ✓' },
    ],
    exercises: [
  ...
  /* ─────────────────────────── 27 · FORMAL EMAILS ─────────────────────────── */
  {
    ...
    examples: [
      { en: 'Subject: *Leave Request — 12–13 August* (topic + the detail that matters)', ar: 'الموضوع: الفكرة + التفصيل المهم' },
      { en: '*Dear Mr. Alami,* — title + FAMILY name, never the first name alone.', ar: 'اللقب + اسم العائلة، لا الاسم الأول' },
      { en: '*I am writing to request* two days of leave on 12 and 13 August.', ar: 'الغرض في الجملة الأولى' },
      { en: '*I would appreciate it if* you could confirm by Thursday.', ar: 'الطلب المهذّب الرسمي' },
      { en: '*Please find attached* my medical certificate.', ar: 'الإشارة إلى المرفقات' },
      { en: 'get → *receive* · want → *would like* · ask → *request* · help out → *assist*', ar: 'استبدال الكلمات العامية برسمية' },
      { en: '*I look forward to your reply.* — the professional way to say “answer me”.', ar: 'الطريقة المهنية لطلب الرد' },
      { en: '✗ “Hi boss, i want 2 days off ok? thx 🙏” → ✓ the full frame above.', ar: 'العامية ✗ ← القالب الرسمي ✓' },
    ],
    exercises: [
  ...
  /* ─────────────────────────── 28 · REQUESTS & COMPLAINTS ─────────────────────────── */
  {
    ...
    examples: [
      { en: 'Subject: *Order #45872 — Not Delivered (3 weeks)* — the whole case in one line.', ar: 'القضية كلها في سطر الموضوع' },
      { en: '*I am writing about* order #45872, a smartphone I purchased on 2 July.', ar: 'الحقائق: ماذا ومتى ورقم' },
      { en: 'Neutral problem: *The order has still not arrived after three weeks.*', ar: 'وصف محايد للمشكلة' },
      { en: 'Softest ask: *Could you please* check the status of my order?', ar: 'أخف درجات الطلب' },
      { en: 'Firmer: *I would appreciate it if* you could deliver it within five days.', ar: 'درجة أحزم' },
      { en: 'Firmest (still polite): *I must request a full refund* under your returns policy.', ar: 'الأحزم مع بقاء الأدب' },
      { en: 'Give two doors: *either deliver the order within five days or refund the full amount*.', ar: 'اعرض خيارين — أسهل على القارئ أن يوافق' },
      { en: '✗ “you are thiefs, i want my money now” → ✓ facts + a specific demand + a date.', ar: 'الغضب ✗ ← الحقائق والمطلب والتاريخ ✓' },
    ],
    exercises: [
  ...
  /* ─────────────────────────── 29 · JOB APPLICATION ─────────────────────────── */
  {
    ...
    examples: [
      { en: 'Subject: *Application for Customer Service Agent — Omar Benali*', ar: 'الموضوع: الوظيفة + الاسم الكامل' },
      { en: '*I am writing to apply for* the Customer Service Agent position *advertised on LinkedIn*.', ar: 'الوظيفة ومصدر الإعلان' },
      { en: 'Who you are in one line: *a Moroccan graduate with two years of experience in Arabic, French, and English*.', ar: 'تعريف بسطر واحد' },
      { en: 'Claim ✗: “I am hard-working.” → Proof ✓: *I answer more than sixty calls a day and keep a 95% satisfaction score.*', ar: 'الادّعاء ✗ ← الدليل ✓' },
      { en: 'Claim ✗: “I work well under pressure.” → Proof ✓: *I handled our busiest Ramadan season without a single escalation.*', ar: 'المثال يثبت ما لا يثبته الوصف' },
      { en: 'Mirror the advert: if it says *“fast-paced team”*, use *fast-paced* about yourself.', ar: 'استخدم كلمات الإعلان نفسها' },
      { en: '*I am available for an interview at any time and can start within one month.*', ar: 'الجاهزية بوضوح' },
      { en: '*Thank you for your consideration.* / *My CV is attached.* + full name + phone.', ar: 'الختام الاحترافي مع بيانات التواصل' },
    ],
    exercises: [
