...
نقدّم 4 مستويات + باقات + دروساً تفاعلية على الموقع (Sentence Builder, Grammar, Reading, Real Life English, Business English).

🆕 قسم **Business English** متاح: 6 وحدات احترافية لمواقف العمل (التعارف وبناء العلاقات، البريد الإلكتروني، المكالمات، الاجتماعات، العروض التقديمية، مقابلات العمل). مناسب لمستوى B1-B2 ولكل من يعمل في بيئة شركات.
